...
export default class CoinRecordItem extends Component {
    static propTypes = {
            ...
            <TouchableOpacity
                ...
                <View style={styles.top}>
                    <View
                        ...
                        <Text
                            style={styles.text}
                            numberOfLines={2}>{item.Remark}</Text>
                    </View>
                ...
                <View style={styles.bottom}>
                    <View style={styles.row}>
                        <Text style={styles.amount}>{item.GiveCount}</Text>
                        <Text style={styles.type}>ETRC类型 {this.getType(item.GiveType)}</Text>
                    </View>
